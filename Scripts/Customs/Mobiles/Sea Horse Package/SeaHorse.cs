...
namespace Server.Mobiles
{
	...
	public class SeaHorse2 : BaseMount
	{
		[Constructable]
		public SeaHorse2() : this( "a sea horse" )
		{
		}

		[Constructable]
		public SeaHorse2( string name ) : base( name, 0x90, 0x3EB3, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public SeaHorse2( Serial serial ) : base( serial )
		{
		}
